...
import com.dwursteisen.gltf.parser.support.GltfDelegate
...
class CameraParserTest {
    ...
    private val rootPath = File(GltfDelegate::class.java.getResource(".")!!.toURI())
    ...
    fun `parse - it parses camera with children`() {
        val scene = SceneParser(rootPath, cameraChildren).parse()
